...
EGIT_REPO_URI="https://github.com/mupen64plus/mupen64plus-ui-python"
...
RDEPEND="media-libs/libsdl2:0/0[joystick]
	...
	=games-emulation/mupen64plus-core-9999:0/2-sdl2"
...
_EOF_
	...
	# force SDL2 support to match >=mupen64plus-9999
	sed -e '/--sdl2/d' \
		-e '/SDL2/s:=.*$:= True:' \
