...
URI_x86="http://rarsoft.com/rar/rarlinux-5.3.b1.tar.gz"
#URI_amd64="http://www.rarlab.com/rar/rarlinux-x64-${MY_PV}.tar.gz"
URI_amd64="http://rarsoft.com/rar/rarlinux-x64-5.3.b1.tar.gz"
#URI_w64="http://www.rarlab.com/rar/winrar-x64-${MY_PV//.}.exe"
URI_w64="http://rarsoft.com/rar/winrar-x64-53b1.exe"
SRC_URI="x86? ( ${URI_x86} )
	amd64? ( ${URI_amd64} )
	all_sfx? (
		${URI_x86}
