...
# $Header: /var/cvsroot/gentoo-x86/app-arch/engrampa/engrampa-1.8.1-r1.ebuild,v 1.1 2015/07/11 23:44:18 np-hardass Exp $
...
src_prepare() {
	#patch no longer needed, changes made upstream
